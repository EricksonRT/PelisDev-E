...
let palabrasRandom = ["2022", "Dogs", "Erick", "Lady", "Terror", "Series", "Ann", "Kids", "Shark", "Final", "Fantasy"];
const random = () => {
...
>>>>>>> 70b45c4c3c964aa85feeeee06e9bdf73d6804a9f
                               </div>`
...
btnSearchSeries.addEventListener("click", () => {
    let url = "https://www.omdbapi.com/?apikey=669a7ccb&s=" + random() + "&r=json&page=1&type=series";
    fetch(url)
        .then(response => response.json())
        .then((data) => {
            // console.log(data);
...
btnSearchMovies.addEventListener("click", () => {
    let url = "https://www.omdbapi.com/?apikey=669a7ccb&s=" + random() + "&r=json&page=1&type=movie";
    fetch(url)
        .then(response => response.json())
        .then((data) => {
            // console.log(data);
...
btnSearchAnime.addEventListener("click", () => {
    let url = "https://www.omdbapi.com/?apikey=669a7ccb&s=anime&r=json&page=1&type=";
    fetch(url)
        .then(response => response.json())
        .then((data) => {
            // console.log(data);
